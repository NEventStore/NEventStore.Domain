...
- Core library code lives under [src/NEventStore.Domain/](src/NEventStore.Domain); tests live under [src/NEventStore.Domain.Tests/](src/NEventStore.Domain.Tests).
- The solution references the NEventStore submodule under [dependencies/NEventStore/](dependencies/NEventStore); check that tree when a change crosses library boundaries.
...
- On Windows, [build.ps1](build.ps1) is the canonical release and packaging flow.
